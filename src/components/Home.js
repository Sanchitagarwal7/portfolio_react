  ...
  return (
    ...
    <Container style={{marginTop: "10vh"}}>
        <Row>
            ...
            <a id='Github' className='mx-2 my-3' href='/'><i class="fa-brands fa-github fa-xl"></i></a>
            <a id='LinkedIn' className='mx-2 my-3' href='/'><i class="fa-brands fa-linkedin fa-xl"></i></a>
            <a id='Twitter' className='mx-2 my-3' href='/'><i class="fa-brands fa-square-twitter fa-xl"></i></a>
