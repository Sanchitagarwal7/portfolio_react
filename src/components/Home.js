  ...
  return (
    ...
    <Container>
        <Row>
            ...
            <h4>$ <span><ReactTyped strings={["Web Developer", "Programmer"]} typeSpeed={100} loop backSpeed={50} cursorChar='_' showCursor={true}/></span></h4>
            ...
            <a id='LinkedIn' className='mx-2' href='/'><i class="fa-brands fa-linkedin fa-xl"></i></a>
            <a id='Github' className='mx-2' href='/'><i class="fa-brands fa-github fa-xl"></i></a>
            <a id='email' className='mx-2' href='/'><i class="fa-regular fa-envelope fa-xl"></i></a>
            <a id='Instagram' className='mx-2' href='/'><i class="fa-brands fa-instagram fa-xl"></i></a>
            </Col>
